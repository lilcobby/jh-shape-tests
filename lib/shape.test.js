...
test("renders the correct SVG string for square", () => {
  ...
  expect(shape.render()).toEqual(
    `<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg"><circle cx="150" cy="130" r="75" fill="blue" /><text x="150" y="130" font-size="50" text-anchor="middle" fill="green">abc</text></svg>`
  );
});
